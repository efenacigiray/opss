...
class Smtp {
    ...
    public function send() {
        ...
        if (!$handle) {
            return false; #throw new \Exception('Error: ' . $errstr . ' (' . $errno . ')');
        } else {
            ...
            if (substr($reply, 0, 3) != 250) {
                return false; #throw new \Exception('Error: EHLO not accepted from server!');
            }
            ...
            if (substr($this->smtp_hostname, 0, 3) == 'tls') {
                ...
                if (substr($reply, 0, 3) != 220) {
                    return false; #throw new \Exception('Error: STARTTLS not accepted from server!');
                }
            ...
            if (!empty($this->smtp_username)  && !empty($this->smtp_password)) {
                ...
                if (substr($reply, 0, 3) != 334) {
                    return false; #throw new \Exception('Error: AUTH LOGIN not accepted from server!');
                }
                ...
                if (substr($reply, 0, 3) != 334) {
                    return false; #throw new \Exception('Error: Username not accepted from server!');
                }
                ...
                if (substr($reply, 0, 3) != 235) {
                    return false; #throw new \Exception('Error: Password not accepted from server!');
                }
            } else {
                ...
                if (substr($reply, 0, 3) != 250) {
                    return false; #throw new \Exception('Error: HELO not accepted from server!');
                }
            }
            ...
            if (substr($reply, 0, 3) != 250) {
                return false; #throw new \Exception('Error: MAIL FROM not accepted from server!');
            }
            ...
            if (!is_array($this->to)) {
                ...
                if ((substr($reply, 0, 3) != 250) && (substr($reply, 0, 3) != 251)) {
                    return false; #throw new \Exception('Error: RCPT TO not accepted from server!');
                }
            } else {
            ...
            if (substr($reply, 0, 3) != 354) {
                return false; #throw new \Exception('Error: DATA not accepted from server!');
            }
            ...
            if (substr($reply, 0, 3) != 221) {
                return false; #throw new \Exception('Error: QUIT not accepted from server!');
            }
