...
class ControllerCustomerCustomerGroup extends Controller {
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['default_password'])) {
            $data['default_password'] = $this->request->post['default_password'];
        } elseif (!empty($customer_group_info)) {
            $data['default_password'] = $customer_group_info['default_password'];
        } else {
