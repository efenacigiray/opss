...
class ControllerSettingSetting extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['config_store_status'])) {
            $data['config_store_status'] = $this->request->post['config_store_status'];
        } elseif ($this->config->get('config_store_status')) {
            $data['config_store_status'] = $this->config->get('config_store_status');
        } else {
            $data['config_store_status'] = array();
        }

        if (isset($this->request->post['config_cancelled_status'])) {
            $data['config_cancelled_status'] = $this->request->post['config_cancelled_status'];
        } elseif ($this->config->get('config_cancelled_status')) {
            $data['config_cancelled_status'] = $this->config->get('config_cancelled_status');
        } else {
            $data['config_cancelled_status'] = array();
        }
