<?php
class ModelExtensionReportDailySale extends Model {
    ...
    public function getOrders($data = array()) {
        $query = $this->db->query("SELECT * FROM `order` WHERE date_added BETWEEN '" . $data['filter_date_start'] . " 00:00:00' AND '" . $data['filter_date_start'] . " 23:59:59'");
        return $query->rows;
    }
