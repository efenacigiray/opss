        ...
        if (!$json) {
            ...
            foreach ($files as $file) {
                if (is_file($file['tmp_name'])) {
                    ...
                    $tmp_filename = basename(html_entity_decode($file['name'], ENT_QUOTES, 'UTF-8'));
                    $filename = pathinfo($tmp_filename, PATHINFO_FILENAME) . "-" . uniqid() . "." . pathinfo($tmp_filename, PATHINFO_EXTENSION);
