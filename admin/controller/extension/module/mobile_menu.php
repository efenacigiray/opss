...
class ControllerExtensionModuleMobileMenu extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/mobile_menu', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['action'] = $this->url->link('extension/module/mobile_menu', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Mobile Menu',
			'href' => $this->url->link('extension/module/mobile_menu', 'user_token=' . $this->session->data['user_token'], true)
		);
