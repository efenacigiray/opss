...
class ModelSaleOrder extends Model {
    ...
    public function getOrders($data = array()) {
        ...
        if (!empty($data['filter_customer'])) {
            $sql .= " AND (CONCAT(o.firstname, ' ', o.lastname) LIKE '%" . $this->db->escape($data['filter_customer']) . "%' OR o.order_id = (SELECT order_id FROM `order_history` WHERE order_history.comment like '%" . $data['filter_customer'] . "%'))";
        }
