      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            ...
            <div class="col-sm-10">
              <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control">
                <option value=""><?php echo $text_select; ?></option>
                		...
                		if($address_custom_field[$test] && $custom_field_value['custom_field_value_id'] == $address_custom_field[$test]) { ?>
              ...
              <?php if($error_custom_field[$test]) { ?>
          ...
          <div class="form-group<?php if($custom_field['required']) { ?> required <?php } ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-sm-2 control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
            <div class="col-sm-10">
              <input type="text" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php $test = $custom_field['custom_field_id']; if($address_custom_field[$test]) { ?><?php echo $address_custom_field[$test]; ?><?php } else { ?><?php echo $custom_field['value']; ?><?php } ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
              <?php if($error_custom_field[$test]) { ?>
              <div class="text-danger"><?php echo $error_custom_field[$test]; ?></div>
              <?php } ?> </div>
          </div>
          ...
          <div class="form-group<?php if($custom_field['required']) { ?> required <?php } ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-sm-2 control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
            <div class="col-sm-10">
              <textarea name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php $test = $custom_field['custom_field_id']; if($address_custom_field[$test]) { ?><?php echo $address_custom_field[$test]; ?><?php } else { ?><?php echo $custom_field['value']; ?><?php } ?></textarea>
              <?php if($error_custom_field[$test]) { ?>
              <div class="text-danger"><?php echo $error_custom_field[$test]; ?></div>
              <?php } ?> </div>
          </div>
          ...
          <div class="form-group<?php if($custom_field['required']) { ?> required <?php } ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php $test = $custom_field['custom_field_id']; if($address_custom_field[$test]) { ?>  <?php echo $address_custom_field[$test]; ?> <?php } ?>" />
              <?php if($error_custom_field[$test]) { ?>
              <div class="text-danger"><?php echo $error_custom_field[$test]; ?></div>
              <?php } ?> </div>
          </div>
