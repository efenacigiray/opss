...
$_['text_returning_customer']      = 'Öğrenci Giriş';
$_['text_i_am_returning_customer'] = 'Lütfen TC Kimlik (Son 7 Hane) veya Öğrenci numaranız ve size iletilen şifre ile giriş yapın';
$_['text_forgotten']               = 'Parolamı Unuttum';

// Entry
$_['entry_email']                  = 'TC Kimlik (Son 7 Hane) veya Öğrenci Numarası';
$_['entry_email_7']                = 'TC Kimlik (Son 7 Hane) veya Öğrenci Numarası';
$_['entry_password']               = 'Parola';

// Error
$_['error_login']                  = 'Uyarı: TC Kimlik (Son 7 Hane) veya Öğrenci numaranız ya da parolanız yanlış!';
