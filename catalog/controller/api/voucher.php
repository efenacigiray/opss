...
class ControllerApiVoucher extends Controller {
    ...
    public function add_store() {
        ...
        if (!isset($this->session->data['api_id'])) {
            ...
            $code = mt_rand();
            $amount = $this->request->post['voucher'];
            ...
            $this->session->data['vouchers'][$code] = array(
                'code'             => $code,
                'description'      => 'Mağaza Satış İndirimi',
                'to_name'          => '',
                'to_email'         => '',
                'from_name'        => 'Sistem',
                'from_email'       => 'Sistem',
                'voucher_theme_id' => 0,
                'message'          => 'Mağaza Satış İndirimi',
                'amount'           => $this->currency->convert($amount, $this->session->data['currency'], $this->config->get('config_currency'))
            );
    ...
    public function add_store_half() {
        $this->load->language('api/voucher');
        ...
        if (!isset($this->session->data['api_id'])) {
            ...
            $this->session->data['vouchers'][$code] = array(
                'code'             => $code,
                'description'      => $this->request->post['type'],
                'to_name'          => '',
                'to_email'         => '',
                'from_name'        => 'Sistem',
                'from_email'       => 'Sistem',
    ...
    public function remove() {
        if (!isset($this->session->data['api_id'])) {
            ...
            unset($this->session->data['vouchers'][$this->request->get['code']]);
