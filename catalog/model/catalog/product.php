...
class ModelCatalogProduct extends Model {
    ...
    public function getProductPackagePrice($product_id, $package_id) {
        $result = $this->db->query("SELECT * FROM package_product WHERE package_id = " . (int)$package_id . " AND product_id = " . (int)$product_id);
        if ($result->num_rows)
            return $result->row['package_price'];
        return 0;
    }

    public function getProduct($product_id, $ignore_store = false) {
        ...
        if ($query->num_rows) {
            return array(
                ...
                'package_description' => $query->row['package_description'],
