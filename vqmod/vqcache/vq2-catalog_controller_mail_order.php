...
class ControllerMailOrder extends Controller {
	...
	public function add($order_info, $order_status_id, $comment, $notify) {
		...
		$data['store_url'] = $order_info['store_url'];
			...
			$data['store_adres'] = $this->config->get('config_address');
			$data['store_telefon'] = $this->config->get('config_telephone');
			$data['store_adi'] = $this->config->get('config_name');	
			$data['store_eposta'] = $this->config->get('config_email');					
