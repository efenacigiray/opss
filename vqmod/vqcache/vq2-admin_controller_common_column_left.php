...
class ControllerCommonColumnLeft extends Controller {
    public function index() {
        if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            $is_admin = $this->session->data['is_admin'];
            ...
            if ($this->user->hasPermission('access', 'catalog/class')) {
                $catalog[] = array(
                    'name'     => $this->language->get('text_class'),
                    'href'     => $this->url->link('catalog/class', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
...
*/
            ...
            if ($this->user->hasPermission('access', 'customer/customer')) {
                $customer[] = array(
                    'name'     => $this->language->get('text_customer_def'),
            ...
            if ($customer) {
                $data['menus'][] = array(
                    ...
                    'href'     => '',
                    'children' => array_merge($customer, $marketing)
                );
            }

            if ($this->user->hasPermission('access', 'sale/store_order')) {
                $data['menus'][] = array(
                    'id'       => 'menu-store',
                    'icon'     => 'icon-star',
                    'name'     => 'Mağaza Satış',
                    'href'     => $this->url->link('sale/store_order/add', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
        ...
        $moduller[] = array(
          'name'     => $this->language->get('quick_status_updater'),
          'href'     => $this->url->link('module/quick_status_updater', 'user_token=' . $this->session->data['user_token'], true),
          'children' => array()
        );
