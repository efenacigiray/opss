...
class ModelCheckoutOrder extends Model {
    ...
    public function reduceStoreStock($product_id, $store_id, $quantity) {
        $this->db->query("UPDATE store_stock SET quantity = (quantity - " . (int)$quantity . ") WHERE product_id = " . (int)$product_id . " AND store_id = " . (int)$store_id);
    }
                ...
                foreach ($extensions as $extension) {
                    if ($this->config->get('fraud_' . $extension['code'] . '_status')) {
                        ...
                        if (property_exists($this->{'model_extension_fraud_' . $extension['code']}, 'check')) {
                            ...
                            if (!$this->config->get('qosu_fraud_coupon_off') && $fraud_status_id) {
    ...
    public function getTrueStore($store_id) {
